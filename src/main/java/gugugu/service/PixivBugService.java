...
public class PixivBugService {
     ...
     * @return 日榜图片信息
     */
    public static List<PixivRankImageInfo> getPixivIllustRank(int pageSize) throws IOException {
        ...
        for (PixivRankImageInfo rankImageInfo : rankImageList) {
            ...
            //下载图片
            String imgCQ = PixivService.getPixivImgCQByPixivImgUrl(pixivImageInfo.getUrls().getOriginal(), NumberUtil.toLong(pixivImageInfo.getId()));
     ...
     * @return 需要的信息
     */
    private static PixivImageInfo getImageInfoByPixivId(Long pixivId) throws IOException {
        //代理
        Proxy proxy = HttpUtil.getProxy();
        //爬虫获取pid图片详情信息
     ...
     */
    private static String parsePixivImgInfoByApiInfo(PixivImageInfo imageInfo, String similarity) throws IOException {
        //图片cq码
        String pixivImgCQ = PixivService.getPixivImgCQByPixivImgUrl(imageInfo.getUrls().getOriginal(), NumberUtil.toLong(imageInfo.getId()));
